...
static int is_non0(qkz80_uint8 abyte) {
  if(abyte!=0)
    return 1;
  return 0;
}

std::string qkz_regs_as_string(qkz80 *cz) {
  std::stringstream ss;
  qkz80_uint8 flags8(cz->regs.get_flags());
  ss
    << std::hex << cz->get_reg16(qkz80::regp_PC) << ";"
    << std::hex << cz->get_reg16(qkz80::regp_SP) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_A)) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_B)) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_C)) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_D)) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_E)) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_H)) << ";"
    << std::hex << int(cz->get_reg8(qkz80::reg_L)) << "|"
    << std::hex << is_non0(flags8&qkz80_cpu_flags::S) << ";"
    << std::hex << is_non0(flags8&qkz80_cpu_flags::Z) << ";"
    << std::hex << is_non0(flags8&qkz80_cpu_flags::AC) << ";"
    << std::hex << is_non0(flags8&qkz80_cpu_flags::P) << ";"
    << std::hex << is_non0(flags8&qkz80_cpu_flags::CY) << std::endl;
    ;
  return ss.str();
}
